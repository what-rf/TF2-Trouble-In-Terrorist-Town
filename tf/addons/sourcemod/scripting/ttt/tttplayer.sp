	...
	public void ShowRoleMenu(Role role = NOROLE)
	{
		...
		switch (role)
		{
			...
			case DETECTIVE:
			{
				...
				panel.DrawItem("Press MOUSE2 to transform! Transformation blinds everyone for 7 seconds.");
				panel.DrawItem("After transformation, hold MOUSE2 to release a huge energy beam!");
				panel.DrawItem("Killing innocents as an innocent lowers your karma, which lowers your damage.");
			}
			...
			case DISGUISER:
			{
				...
				panel.DrawItem("Kill all the innocents without dying!");
				panel.DrawItem("Your teammates are marked with an outline.");
				panel.DrawItem("Press MOUSE2 to kill your target and get their cosmetics!");
			}
